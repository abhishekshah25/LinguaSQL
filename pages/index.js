...
export default function Home() {
  ...
  const handleCopy = (text, isHistory) => {
          ...
          >
            <div className="flex flex-col h-full">
              ...
              <textarea
                ...
                placeholder={
                  isHumanToSql
                    ? "e.g. Show me the list of employees having income more than 30000"
                    : "SELECT * FROM Employees WHERE Income > 30000 "
                }
                value={inputText}
              ...
              <div className="flex items-center justify-between my-3 last:mb-0 space-x-10">
                ...
                <button
                  type="submit"
                  className={`cursor-pointer py-2 px-4 rounded-full blue-button-w-gradient-border [text-shadow:0_0_1px_rgba(0,0,0,0.25)] shadow-2xl flex flex-row items-center justify-start ${translating &&
              ...
              >
                {isOutputTextUpperCase
                  ...
                  : outputText.toLowerCase() ||
                    (isHumanToSql
                      ? "SELECT * FROM Employees WHERE Income > 30000 "
                      : "Show me the list of employees having income more than 30000")}
              </SyntaxHighlighter>
            </div>
